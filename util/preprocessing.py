# Heavily copied from https://github.com/UKPLab/emnlp2017-bilstm-cnn-crf
...
def perpareDataset(embeddingsPath, datasets, frequencyThresholdUnknownTokens=50, reducePretrainedEmbeddings=True, valTransformations=None, padOneTokenSentence=True):
    """
    ...
    outputPath = './data/pkl/' + pklName + '.pkl'
